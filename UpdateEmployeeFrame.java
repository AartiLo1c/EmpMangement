...
public class UpdateEmployeeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtEmpName.setForeground(new java.awt.Color(51, 255, 51));
        ...
        txtEmpNo.setForeground(new java.awt.Color(0, 255, 0));

        btnUpdate.setFont(new java.awt.Font("Tahoma", 3, 24)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtEmpNo, javax.swing.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
       ...
       try
       {
           ...
           if(result==true)
           {
                JOptionPane.showMessageDialog(null,"record  update","success",JOptionPane.INFORMATION_MESSAGE);
           }
           else{
                JOptionPane.showMessageDialog(null,"record cannot be updated","PROBLEM",JOptionPane.WARNING_MESSAGE);
           }
       }
       catch(NumberFormatException ex)
       {
           JOptionPane.showMessageDialog(null,"plzz error","error",JOptionPane.ERROR_MESSAGE);
           ex.printStackTrace();
       }
